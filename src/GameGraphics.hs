...
drawTimer app pics | optionTimeLimit (appGameOptions app) == Nolimit = [Blank]
                   | otherwise = [timerBlackPic, timerWhitePic]
                   where
                     ...
                     timerBlackPic = translate (offsetX + c2) magicY (color' x $ Scale 0.3 0.3 $ Text $ show x)
                                    ...
                                    translate 
                                    (offsetX + c4) 
                                    (offsetY + fromIntegral sizeField / 2 * sizeCell + 50) (buttonImage timerBlackBtn)
                     ...
                     timerWhitePic = translate (offsetX + c1) magicY (color' y $ Scale 0.3 0.3 $ Text $ show y)
                                    ...
                                    translate 
                                    (offsetX + c3) 
                                    (offsetY + fromIntegral sizeField / 2 * sizeCell + 50) (buttonImage timerWhiteBtn)               
...
drawBoard posX posY n board  = drawRow posX posY (GameGraphics.getRow 1 board)
                              ++
                              drawBoard
